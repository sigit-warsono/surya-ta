...
<ul class="sidebar-menu">
	...
	if($_GET["module"]=="barang" || $_GET["module"]=="barang") { ?>
    <li class="active">
    ...
    <li class="active">
        <a href="?module=barang_masuk"><i class="fa fa-cloud-download"></i>Transaksi Barang Masuk</a>
    </li>
    ...
    <li class="active">
        <a href="?module=barang_keluar"><i class="fa fa-share-square"></i>Transaksi Barang Keluar</a>
    </li>
