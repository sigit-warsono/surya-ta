    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <!-- form start -->
                <form role="form" class="form-horizontal" method="GET" action="modules/lap_peramalan/cetak.php"
                    target="_blank">
                    <div class="box-body">
                        <div class="form-group">
                            <label class="col-sm-1">Bulan</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control date-picker-bulan" data-date-format="mm-yyyy"
                                    name="bln_awal" autocomplete="off" required>
                            </div>

                            <label class="col-sm-1">s.d.</label>
                            <div class="col-sm-2">
                                <input style="margin-left:-35px" type="text" class="form-control date-picker-bulan"
                                    data-date-format="mm-yyyy" name="bln_akhir" autocomplete="off" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select class="chosen-select" name="kd_barang" data-placeholder="--Pilih--"
                                    id="kd_barang">
                                    <option value=""></option>
                                    <?php 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select class="chosen-select" name="metode" data-placeholder="--Pilih Metode--"
