...
if(isset($_POST['dataidbarang'])){
	...
	$query = mysqli_query($mysqli, "SELECT kd_barang,nama_barang,kategori,stok FROM tb_barang WHERE kd_barang='$kd_barang'") or die('Ada kesalahan pada query tampil data barang: '.mysqli_error($mysqli));
