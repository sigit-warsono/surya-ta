				...
				<div class="box-body">
					...
					<table id="dataTables1" class="table table-bordered table-striped table-hover">
						...
						<tbody>
							...
							$query = mysqli_query($mysqli, "SELECT kd_barang,nama_barang,kategori,harga_beli,harga_jual,stok FROM tb_barang ORDER BY nama_barang ASC") or die('Ada kesalahan pada query tampil data barang: '.mysqli_error($mysqli));
