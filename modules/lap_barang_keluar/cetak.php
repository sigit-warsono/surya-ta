<?php 
	...
	if(isset($_GET['tgl_awal'])){
		...
		$query = mysqli_query($mysqli, "SELECT a.kd_transaksi,a.tanggal_keluar,b.kd_barang,b.nama_barang,a.jumlah_keluar,a.harga,a.sub_total FROM detail_keluar as a INNER JOIN tb_barang as b ON a.kd_barang=b.kd_barang WHERE a.tanggal_keluar BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY a.kd_transaksi ASC") or die('Ada kesalahan pada query tampil Transaksi : '.mysqli_error($mysqli));
 		 				...
 		 				// jika data tdk ada
 		 					...
 		 					while ($data=mysqli_fetch_assoc($query)){
 		 						...
 		 						echo "<tr>
 		 								...
 		 								<td width='200' height='13' align='center' valign='middle'>$data[sub_total]</td>
 		 							</tr>";
 		 						$no++;
 		 					}
 		 				}
