			...
			<?php 
				...
				elseif($_GET['alert']==3){
					echo "<div class='alert alert-success alert-dismissable'>
							<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
							<h4><i class='icon fa fa-check-circle'></i>Sukses!</h4>
							Data Barang baru berhasil dihapus.
						</div>";
				}
			 ?>
			 		...
			 		<table id="dataTables1" class="table table-bordered table-striped table-hover">
			 			...
			 			<tbody>
			 				<?php 
			 					...
			 					$query=mysqli_query($mysqli,"SELECT a.kd_barang,b.nama_supplier,a.nama_barang,a.kategori,a.harga_beli,a.harga_jual,a.stok FROM tb_barang a INNER JOIN tb_supplier b ON a.kd_supplier = b.kd_supplier ORDER BY a.kd_barang DESC") or die('Ada kesalahan pada query tampil data pakaian: '.mysqli_error($mysqli));
