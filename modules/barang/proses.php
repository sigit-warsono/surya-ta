<?php 
	...
	// jika user sdh login, maka jalankan perintah utk insert, update dan delete
		...
		if($_GET['act']=='insert') {
			...
			$query = mysqli_query ($mysqli, "INSERT INTO tb_barang(kd_barang,kd_supplier,nama_barang,kategori,harga_beli,harga_jual, created_user,updated_user) VALUES('$kd_barang','$kd_supplier','$nama_barang','$kategori','$harga_beli','$harga_jual','$created_user','$created_user')") or die('Ada kesalahan pada query insert : '.mysqli_error($mysqli));
