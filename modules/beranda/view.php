		...
		<div class="col-lg-12 col-xs-12">
			<div class="alert alert-info alert-dismissable">
				...
				<p style="font-size: 15px">
					<i class="icon fa fa-user"></i>Selamat Datang <strong><?php echo $_SESSION['nama_user']; ?></strong> di Aplikasi Sistem Informasi Peramalan Penjualan Karet Vulkanisir
				</p>
			</div> 
		</div>
	</div>
		...
		<div class="col-lg-3 col-xs-6">
			...
			<div style="background-color: #00a65a;color: #fff" class="small-box">
				<div class="inner">
					 ...
					 $query =mysqli_query($mysqli, "SELECT COUNT(kd_transaksi)as jumlah FROM tb_barang_masuk") or die('Ada kesalahan pada query tampil data Barang Masuk: '.mysqli_error($mysqli));
					 // tampil data
					 $data = mysqli_fetch_assoc($query);
					 ?>
					 <h3><?php echo $data['jumlah']; ?></h3>
		...
		<div class="col-lg-3 col-xs-6">
			...
			<div style="background-color: #6F00FF;color: #fff" class="small-box">
				<div class="inner">
					 ...
					 $query =mysqli_query($mysqli, "SELECT COUNT(kd_transaksi)as jumlah FROM tb_barang_keluar") or die('Ada kesalahan pada query tampil data Barang Keluar: '.mysqli_error($mysqli));
					 // tampil data
					 $data = mysqli_fetch_assoc($query);
					 ?>
					 <h3><?php echo $data['jumlah']; ?></h3>
		...
		<div class="col-lg-3 col-xs-6">
 			...
 			<div style="background-color: #f39c12;color: #fff" class="small-box">
 				<div class="inner">
 					...
 					$query = mysqli_query($mysqli, "SELECT COUNT(kd_barang) as jumlah FROM tb_barang") or die('Ada kesalahan pada query tampil data barang: '.mysql_error($mysqli));
