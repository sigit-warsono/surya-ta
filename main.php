...
<head>
    <meta charset="utf-8">
    <title>Aplikasi Peramalan Penjualan Karet Vulkanisir</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Peramalan Persediaan barang">
    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="?module=beranda" class="logo">
                <span style="font-size: 18px">Apotek rizki farma</span>
            </a>
            <!-- header navbar -->
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; - <a href="www.sediatek.com"> </a></strong>
        </footer>
    </div>
