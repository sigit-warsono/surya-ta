               ...
               $awal = 0;
 		 					...
 		 					for ($i=0; $i < $jbul; $i++) { 
								...
								$bulan_depans = date('m', strtotime('+'.($i+1).' MONTH', $timestamp));
	 		 					echo "<tr>
	 		 					<td height='13' align='justify' valign='middle' colspan='3'>Peramalan Bulan ".$namaBulan[$bulan_depans]." ".$tahun_depans."</td>
	 		 					<td height='13' align='right' valign='middle' colspan='2'>".pt($output/($total_bobot+$bobot))."</td>
	 		 							</tr>";
	 		 					$awal = $peramalan;
	 		 					$peramalan = $output;
	 		 				}
